...
const localhost = `mongodb://127.0.0.1:27017/Sistema_Rh`;
    ...
    const SchemaOrgaoEmissorIdent = mongoose.Schema({
        sigla: {
            type: String,
            required: true,
        },
    ...
    const model = mongoose.model('lista_orgaos_emissores_identidade', SchemaOrgaoEmissorIdent);

    const lista_orgaos_emissor_identidade = [{
            sigla: 'ABNC',
        ...
        {
            sigla: 'CGPMAF',
            extenso: 'Coordenadoria Geral de Polícia Marítima, Aeronáutica e de Fronteiras',
        },
        {
            sigla: 'CIPC',
        ...
        {
            sigla: 'IICCECF',
            extenso: 'Instituto de Identificação Civil e Criminal Engrácia da Costa Francisco',
        },
        {
            sigla: 'IICM',
        ...
        {
            sigla: 'SESPAP',
            extenso: 'Secretaria de Estado da Segurança Pública e Administração Penitenciária',
        },
        {
            sigla: 'SESPDC',
        ...
        {
            sigla: 'SSPCGP',
            extenso: 'Secretaria de Segurança Pública e Coordenadoria Geral de Perícias',
        },
        {
            sigla: 'SSPDC',
    ...
    module.exports = OrgaosEmissorIdentidade